...
export const ShareAltIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const DrPawsLogo: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg viewBox="0 0 120 24" xmlns="http://www.w3.org/2000/svg" {...props}>
    ...
    <text x="30" y="17" fontFamily="sans-serif" fontSize="14" fontWeight="bold" fill="currentColor" className="text-slate-300">Dr. Paws</text>
  </svg>
);


export const DogIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M10 5.172C10 3.782 8.423 2.679 7.12 3.373A4 4 0 0 0 4.787 7.05c-.03.14-.05.283-.05.433V10l3.433 3.433a1 1 0 0 1 .293.707V19a1 1 0 0 0 1 1h.5a1 1 0 0 0 1-1v-2.131a1 1 0 0 1 .293-.707L13 9.43V5.172Z" /><path d="M14 6.133c0-1.144.982-2.093 2.112-1.956a3.27 3.27 0 0 1 2.802 2.802C19.093 8.018 18.144 9 17 9h-2.131a1 1 0 0 1-.707-.293L13 7.57V6.133Z" /></svg>
);

export const CatIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 5c.67 0 1.35.09 2 .26 1.78.43 2.9 2.13 2.5 3.92A4.003 4.003 0 0 1 12 13h-1.34a1 1 0 0 0-1 .73 3.001 3.001 0 0 0 5.43 2.07c.39-.42.6-1.01.6-1.67V13h.5a1.5 1.5 0 0 0 1.5-1.5v-1a1.5 1.5 0 0 0-1.5-1.5H13a4.01 4.01 0 0 1-3.66-2.12C8.82 5.92 10.32 5 12 5Z" /><path d="M3.5 4.5a.5.5 0 1 0 0-1 .5.5 0 0 0 0 1Z" /><path d="M11 19.5a.5.5 0 1 0 0-1 .5.5 0 0 0 0 1Z" /></svg>
);

export const BirdIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M16 7.062c0-4.17 3-4.543 3-4.543s.373 4.543-3 4.543" /><path d="M14.53 10.438c-3.14 3.14-3.14 8.23 0 11.37l1.06-1.06" /><path d="M16 7.062c-3.14 3.14-8.23 3.14-11.37 0l1.06-1.06" /><path d="M11.938 10.938c-2.092 2.092-2.092 5.498 0 7.59" /><path d="M3.235 12.875a6.03 6.03 0 0 0 8.618 8.618L12 21.362l.147.133" /><path d="M3.235 12.875a6.03 6.03 0 0 1 8.618-8.618L12 4.125l.147-.133" /><path d="M12 4.125c1.458-1.458 3.56-2.125 5.625-2.125" /><path d="M12 21.362c1.458 1.458 3.56 2.125 5.625 2.125" /><circle cx="12" cy="12" r="2" /></svg>
);
...
export const StopIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><rect x="6" y="6" width="12" height="12" /></svg>
);
...
export const HealthIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <path d="M3.42 15.24a2.5 2.5 0 0 0 3.54 0" />
    </svg>
);
...
export const LightbulbIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M9 18h6v2H9v-2zm3-16C8.13 2 5 5.13 5 9c0 2.38 1.19 4.47 3 5.74V17h2v-2.26c1.81-1.27 3-3.36 3-5.74 0-3.87-3.13-7-7-7z" /></svg>
);

export const MemoriesIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
export const AnalyticsIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M3 3v18h18" /><path d="M18.7 8a5 5 0 0 1-5.7 6.4" /><path d="M13 14.5a5 5 0 0 1 5.7-6.4" /><path d="M13 21v-5.5" /><path d="M8 21v-2" /><path d="M18 21v-7.5" /></svg>
);
...
export const ThemeMoonIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
export const SparklesIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="m12 2-2.5 5L2 9.5l5 2.5L9.5 17l2.5-5L17 9.5l-5-2.5z"/><path d="M5 2v2"/><path d="M19 2v2"/><path d="M5 20v2"/><path d="M19 20v2"/><path d="M2 5h2"/><path d="M2 19h2"/><path d="M20 5h2"/><path d="M20 19h2"/></svg>
);
...
export const SoundWaveIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M2 8v8" /><path d="M6 5v14" /><path d="M10 2v20" /><path d="M14 5v14" /><path d="M18 8v8" /><path d="M22 11v2" /></svg>
);
...
export const WaterIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 22a7 7 0 0 0 7-7c0-2-1-3.9-3-5.5s-3.5-4-4-6.5c-.5 2.5-2 4.9-4 6.5s-3 3.5-3 5.5a7 7 0 0 0 7 7z"></path></svg>
);
...
export const LiveFeedIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><circle cx="12" cy="12" r="2"/><path d="M16.24 7.76a6 6 0 0 1 0 8.49m-8.48 0a6 6 0 0 1 0-8.49m11.31-2.82a10 10 0 0 1 0 14.14m-14.14 0a10 10 0 0 1 0-14.14"/></svg>
);

export const MeaningIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
export const DrPawsChatIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
export const NoMemoriesIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M13 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9z" /><polyline points="13 2 13 9 20 9" /><line x1="10" y1="14" x2="14" y2="18" /><line x1="14" y1="14" x2="10" y2="18" /></svg>
);

export const ClapperboardIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M4 11v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8" /><path d="M4 11V7a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v4" /><line x1="4" y1="11" x2="20" y2="11" /><line x1="4" y1="7" x2="20" y2="7" /><line x1="12" y1="2" x2="12" y2="7" /></svg>
);
...
export const BrainIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M9.5 2A2.5 2.5 0 0 1 12 4.5v0A2.5 2.5 0 0 1 9.5 7h-2A2.5 2.5 0 0 0 5 9.5v0A2.5 2.5 0 0 0 7.5 12h1A2.5 2.5 0 0 1 11 14.5v0A2.5 2.5 0 0 1 8.5 17h-1A2.5 2.5 0 0 0 5 19.5v0A2.5 2.5 0 0 0 7.5 22h9a2.5 2.5 0 0 0 2.5-2.5v0A2.5 2.5 0 0 0 16.5 17h-1a2.5 2.5 0 0 1-2.5-2.5v0A2.5 2.5 0 0 1 13 12h1a2.5 2.5 0 0 0 2.5-2.5v0A2.5 2.5 0 0 0 16.5 7h-2a2.5 2.5 0 0 1-2.5-2.5v0A2.5 2.5 0 0 1 14.5 2z"/></svg>
);
...
export const GameControllerIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M16.5 8.5v1.5M16.5 14v1.5M16.5 11h-1.5M16.5 11l1.5 1.5M16.5 11l1.5-1.5M4.5 11h6"/><path d="M7.5 8v6"/><path d="M2 12c0-2.8 2.2-5 5-5h10c2.8 0 5 2.2 5 5v3c0 2.8-2.2 5-5 5H7c-2.8 0-5-2.2-5-5z"/></svg>
);
...
export const HandIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M18 11V6a2 2 0 0 0-2-2v0a2 2 0 0 0-2 2v0" /><path d="M14 10V4a2 2 0 0 0-2-2v0a2 2 0 0 0-2 2v2" /><path d="M10 10.5V6a2 2 0 0 0-2-2v0a2 2 0 0 0-2 2v8" /><path d="M18 8a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h2v-2" /><path d="M6 14a2 2 0 0 0-2 2v4h2" /></svg>
);

export const TrainingIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M22 10v6M2 10l10-5 10 5-10 5z" /><path d="M6 12v5c0 1.7 3.1 3 6 3s6-1.3 6-3v-5" /></svg>
);

export const EnrichmentIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M9.5 2A2.5 2.5 0 0 1 12 4.5v0A2.5 2.5 0 0 1 9.5 7h-2A2.5 2.5 0 0 0 5 9.5v0A2.5 2.5 0 0 0 7.5 12h1A2.5 2.5 0 0 1 11 14.5v0A2.5 2.5 0 0 1 8.5 17h-1A2.5 2.5 0 0 0 5 19.5v0A2.5 2.5 0 0 0 7.5 22h9a2.5 2.5 0 0 0 2.5-2.5v0A2.5 2.5 0 0 0 16.5 17h-1a2.5 2.5 0 0 1-2.5-2.5v0A2.5 2.5 0 0 1 13 12h1a2.5 2.5 0 0 0 2.5-2.5v0A2.5 2.5 0 0 0 16.5 7h-2a2.5 2.5 0 0 1-2.5-2.5v0A2.5 2.5 0 0 1 14.5 2z"/></svg>
);
...
export const BedIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M2 4v16" /><path d="M2 10h20" /><path d="M6 4v16" /><path d="M14 4v16" /><path d="M14 12h8" /><path d="M18 12v8" /></svg>
);

export const ShuffleIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><polyline points="16 3 21 3 21 8" /><line x1="4" y1="20" x2="21" y2="3" /><polyline points="16 16 21 16 21 21" /><line x1="4" y1="4" x2="11" y2="11" /></svg>
);
...
export const PaletteIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><circle cx="13.5" cy="6.5" r=".5" fill="currentColor"/><circle cx="17.5" cy="10.5" r=".5" fill="currentColor"/><circle cx="8.5" cy="7.5" r=".5" fill="currentColor"/><circle cx="6.5" cy="12.5" r=".5" fill="currentColor"/><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.667 0-.424-.163-.82-.437-1.125-.29-.289-.438-.652-.438-1.125a1.64 1.64 0 0 1 1.667-1.667h1.996c3.051 0 5.5-2.449 5.5-5.5S17.051 2 12 2z"/></svg>
);
...
export const SealOfApprovalIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
export const GlassesIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><circle cx="6" cy="15" r="4"/><circle cx="18" cy="15" r="4"/><path d="M14 15a2 2 0 0 0-2-2 2 2 0 0 0-2 2"/><path d="M2.5 13 5 7c.7-1.3 1.4-2 3-2"/></svg>
);

export const DiademIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M4 5a2 2 0 1 0 0 4 2 2 0 1 0 0-4z"/><path d="M12 4h.01"/><path d="M20 5a2 2 0 1 0 0 4 2 2 0 1 0 0-4z"/><path d="M4 13a2 2 0 1 0 0 4 2 2 0 1 0 0-4z"/><path d="M12 17h.01"/><path d="M20 13a2 2 0 1 0 0 4 2 2 0 1 0 0-4z"/><path d="m5 13-1-8 4-1 4 1-1 8"/><path d="m19 13 1-8-4-1-4 1 1 8"/><path d="M12 4a5.5 5.5 0 0 0-5.24 3.76"/><path d="M12 4a5.5 5.5 0 0 1 5.24 3.76"/></svg>
);

export const BeardIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M16.5 16.5a2 2 0 0 0-3 0m-6 0a2 2 0 0 1 3 0m-3-4.5a2 2 0 0 0-3 0m6 0a2 2 0 0 1 3 0m-3-4.5a2 2 0 0 0-3 0m6 0a2 2 0 0 1 3 0M2 12s2-8 10-8 10 8 10 8-2 8-10 8-10-8-10-8z"/></svg>
);

export const HeartEyesIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10 10-4.5 10-10S17.5 2 12 2z"/><path d="M8 14s1.5 2 4 2 4-2 4-2"/><path d="M9 9c0 .75.5 1.5 1 1.5.5.0 1-.75 1-1.5.0-.5-.5-1-1-1s-1 .5-1 1z" transform="translate(0 -1)"/><path d="M15 9c0 .75.5 1.5 1 1.5.5.0 1-.75 1-1.5.0-.5-.5-1-1-1s-1 .5-1 1z" transform="translate(0 -1)"/><path d="M8.5 9.5c0 .75-.5 1.5-1 1.5s-1-.75-1-1.5.5-1.5 1-1.5 1 .75 1 1.5z" transform="translate(1 0)"/><path d="M15.5 9.5c0 .75-.5 1.5-1 1.5s-1-.75-1-1.5.5-1.5 1-1.5 1 .75 1 1.5z" transform="translate(1 0)"/></svg>
);
